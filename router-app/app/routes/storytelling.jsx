...
import kaartImg         from "../assets/scrollytelling/pop-ups/kaart.png";
...
const MODAL_CONTENT = {
  beer: {
    title: "A Beer from Antwerp",
    body:  "Every bar in Antwerp tells a story — one sip at a time. Craft breweries have called this city home for centuries, leaving stains of stories on coasters in bars.",
    image: beerCoasterImg,
  },
  silvius: {
    title: "Silvius Brabo",
    body:  "Legend has it that the Roman soldier Silvius Brabo cut off the hand of the giant Druon Antigoon and threw it into the river — giving Antwerp (hand-werpen) its name.",
    image: polaroidsImg,
  },
  maria: {
    title: "Our Lady of Antwerp",
    body:  "The Cathedral of Our Lady rises over the city skyline, a Gothic masterpiece that took nearly two centuries to complete. Some keep it as a memory. Others pass it on.",
    image: kaartImg,
  },
};
